...
class JavadocFixture {

  @JvmField @Rule val testFixturesRule = TestFixturesRule()

  @Test fun checkJavadocCompiles() {
    val testSqFile = testFixturesRule.createTestSqFile("com/sample/Test.sq", SQL)
    testFixturesRule.checkCompilesTo(testSqFile, JAVA)
  }
